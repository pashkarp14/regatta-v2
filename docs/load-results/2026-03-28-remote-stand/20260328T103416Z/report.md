...
- Started: 2026-03-28T10:34:20.228Z
- Finished: 2026-03-28T10:34:37.595Z
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| POST /api/rooms | 1 | 35.97 | 35.97 | 35.97 | 35.97 | 0.0 |
| POST /api/rooms/join | 9 | 159.2 | 361.17 | 361.17 | 361.17 | 0.0 |

## Socket
| Metric | Count | P50 ms | P95 ms | P99 ms | Max ms |
| --- | ---: | ---: | ---: | ---: | ---: |
| socket connect | 10 | 41.37 | 5007.05 | 5007.05 | 5007.05 |
| join_socket -> snapshot | 8 | 27.0 | 35.0 | 35.0 | 35.0 |
...
- Histogram highlights:
  ...
  regatta_http_request_duration_seconds [endpoint=/api/rooms/join,method=POST,status=200] count=9 p95=0.4 p99=0.4 avg=0.1305
  regatta_http_request_duration_seconds [endpoint=/metrics,method=GET,status=200] count=1 p95=0.01 p99=0.01 avg=0.0078
  regatta_public_room_view_duration_seconds [default] count=26 p95=0.0005 p99=0.005 avg=0.0003
  ...
  regatta_room_store_duration_seconds [backend=redis,operation=get_room,result=ok] count=26 p95=0.01 p99=0.025 avg=0.0027
  regatta_room_store_duration_seconds [backend=redis,operation=save_room,result=ok] count=10 p95=0.005 p99=0.005 avg=0.0015
  ...
  regatta_socket_event_duration_seconds [event=disconnect,result=ok] count=8 p95=0.01 p99=0.01 avg=0.0051
  regatta_socket_event_duration_seconds [event=room:join_socket,result=ok] count=8 p95=0.05 p99=0.05 avg=0.0231

## Findings from load runner
- Socket connect count: 10
- join_socket -> snapshot p95: 35.0 ms
