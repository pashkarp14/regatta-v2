...
- Started: 2026-03-28T10:31:59.445Z
- Finished: 2026-03-28T10:32:17.625Z
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| POST /api/rooms | 1 | 39.99 | 39.99 | 39.99 | 39.99 | 0.0 |
| POST /api/rooms/join | 9 | 155.76 | 362.57 | 362.57 | 362.57 | 0.0 |

## Socket
| Metric | Count | P50 ms | P95 ms | P99 ms | Max ms |
| --- | ---: | ---: | ---: | ---: | ---: |
| socket connect | 10 | 37.97 | 5009.4 | 5009.4 | 5009.4 |
| join_socket -> snapshot | 8 | 32.0 | 63.0 | 63.0 | 63.0 |
...
- Histogram highlights:
  ...
  regatta_http_request_duration_seconds [endpoint=/api/rooms,method=POST,status=200] count=1 p95=0.005 p99=0.005 avg=0.0047
  regatta_http_request_duration_seconds [endpoint=/api/rooms/join,method=POST,status=200] count=9 p95=0.4 p99=0.4 avg=0.1098
  ...
  regatta_room_store_duration_seconds [backend=redis,operation=get_room,result=ok] count=26 p95=0.01 p99=0.01 avg=0.0029
  regatta_room_store_duration_seconds [backend=redis,operation=save_room,result=ok] count=10 p95=0.005 p99=0.005 avg=0.0016
  ...
  regatta_socket_event_duration_seconds [event=disconnect,result=ok] count=8 p95=0.01 p99=0.01 avg=0.0074
  regatta_socket_event_duration_seconds [event=room:join_socket,result=ok] count=8 p95=0.05 p99=0.05 avg=0.0243

## Findings from load runner
- Socket connect count: 10
- join_socket -> snapshot p95: 63.0 ms
