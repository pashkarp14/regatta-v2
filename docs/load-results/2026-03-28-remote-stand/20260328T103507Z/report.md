...
- Started: 2026-03-28T10:35:12.429Z
- Finished: 2026-03-28T10:35:24.436Z
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| POST /api/rooms | 1 | 35.49 | 35.49 | 35.49 | 35.49 | 0.0 |
| POST /api/rooms/join | 7 | 151.17 | 261.65 | 261.65 | 261.65 | 0.0 |

## Socket
| Metric | Count | P50 ms | P95 ms | P99 ms | Max ms |
| --- | ---: | ---: | ---: | ---: | ---: |
| socket connect | 8 | 33.62 | 44.08 | 44.08 | 44.08 |
| join_socket -> snapshot | 8 | 31.0 | 47.0 | 47.0 | 47.0 |
...
- Histogram highlights:
  ...
  regatta_http_request_duration_seconds [endpoint=/api/library/maps/<record_id>,method=GET,status=200] count=1 p95=0.005 p99=0.005 avg=0.0014
  regatta_http_request_duration_seconds [endpoint=/api/rooms,method=POST,status=200] count=1 p95=0.005 p99=0.005 avg=0.004
  regatta_http_request_duration_seconds [endpoint=/api/rooms/join,method=POST,status=200] count=7 p95=0.4 p99=0.4 avg=0.0933
  regatta_http_request_duration_seconds [endpoint=/metrics,method=GET,status=200] count=1 p95=0.01 p99=0.01 avg=0.0077
  regatta_public_room_view_duration_seconds [default] count=24 p95=0.0005 p99=0.0005 avg=0.0002
  regatta_public_room_view_payload_bytes [default] count=24 p95=8192.0 p99=8192.0 avg=4607.25
  regatta_room_players_histogram [default] count=24 p95=8.0 p99=8.0 avg=6.8333
  regatta_room_store_duration_seconds [backend=redis,operation=get_room,result=ok] count=24 p95=0.01 p99=0.01 avg=0.0028
  regatta_room_store_duration_seconds [backend=redis,operation=save_room,result=ok] count=8 p95=0.005 p99=0.005 avg=0.0011
  regatta_room_store_payload_bytes [backend=redis,operation=get_room] count=23 p95=16384.0 p99=16384.0 avg=11456.6087
  regatta_room_store_payload_bytes [backend=redis,operation=save_room] count=8 p95=16384.0 p99=16384.0 avg=8416.5
  regatta_socket_event_duration_seconds [event=disconnect,result=ok] count=8 p95=0.01 p99=0.01 avg=0.0046
  regatta_socket_event_duration_seconds [event=room:join_socket,result=ok] count=8 p95=0.05 p99=0.05 avg=0.02

## Findings from load runner
- Socket connect count: 8
- join_socket -> snapshot p95: 47.0 ms
