...
- Scenario: live_race
- Started: 2026-03-28T10:35:42.472Z
- Finished: 2026-03-28T10:36:12.485Z
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| GET /api/rooms/7R3DOK | 1 | 20020.2 | 20020.2 | 20020.2 | 20020.2 | 1.0 |
| POST /api/rooms | 1 | 35.69 | 35.69 | 35.69 | 35.69 | 0.0 |
| POST /api/rooms/join | 7 | 154.26 | 255.26 | 255.26 | 255.26 | 0.0 |

## Socket
| Metric | Count | P50 ms | P95 ms | P99 ms | Max ms |
| --- | ---: | ---: | ---: | ---: | ---: |
| socket connect | 8 | 41.33 | 46.17 | 46.17 | 46.17 |
| join_socket -> snapshot | 8 | 29.0 | 61.0 | 61.0 | 61.0 |
...
- Histogram highlights:
  regatta_game_state_payload_bytes [default] count=27 p95=8192.0 p99=8192.0 avg=2423.6296
  regatta_game_state_validation_duration_seconds [default] count=27 p95=0.0005 p99=0.0005 avg=0.0001
  ...
  regatta_http_request_duration_seconds [endpoint=/api/rooms,method=POST,status=200] count=1 p95=0.005 p99=0.005 avg=0.0042
  regatta_http_request_duration_seconds [endpoint=/api/rooms/<room_code>,method=GET,status=200] count=1 p95=0.005 p99=0.005 avg=0.0027
  regatta_http_request_duration_seconds [endpoint=/api/rooms/join,method=POST,status=200] count=7 p95=0.4 p99=0.4 avg=0.1105
  regatta_http_request_duration_seconds [endpoint=/metrics,method=GET,status=200] count=1 p95=0.01 p99=0.01 avg=0.008
  regatta_public_room_view_duration_seconds [default] count=25 p95=0.0005 p99=0.0005 avg=0.0002
  regatta_public_room_view_payload_bytes [default] count=25 p95=8192.0 p99=8192.0 avg=4631.24
  regatta_room_players_histogram [default] count=25 p95=8.0 p99=8.0 avg=6.88
  regatta_room_store_duration_seconds [backend=redis,operation=get_room,result=ok] count=25 p95=0.01 p99=0.01 avg=0.0022
  regatta_room_store_duration_seconds [backend=redis,operation=save_room,result=ok] count=8 p95=0.005 p99=0.005 avg=0.0015
  regatta_room_store_payload_bytes [backend=redis,operation=get_room] count=24 p95=16384.0 p99=16384.0 avg=11524.1667
  regatta_room_store_payload_bytes [backend=redis,operation=save_room] count=8 p95=16384.0 p99=16384.0 avg=8416.5
  regatta_socket_event_duration_seconds [event=disconnect,result=ok] count=8 p95=0.01 p99=0.01 avg=0.0064
  regatta_socket_event_duration_seconds [event=room:join_socket,result=ok] count=8 p95=0.05 p99=0.05 avg=0.0246

## Findings from load runner
- Socket connect count: 8
- join_socket -> snapshot p95: 61.0 ms
