...
- Scenario: smoke_1x2
- Started: 2026-03-28T10:37:03.453Z
- Finished: 2026-03-28T10:37:38.214Z
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| GET /api/rooms/J9LB5D | 1 | 23.84 | 23.84 | 23.84 | 23.84 | 0.0 |
| POST /api/rooms | 1 | 40.21 | 40.21 | 40.21 | 40.21 | 0.0 |
| POST /api/rooms/J9LB5D/start | 1 | 31.0 | 31.0 | 31.0 | 31.0 | 0.0 |
| POST /api/rooms/join | 1 | 30.16 | 30.16 | 30.16 | 30.16 | 0.0 |
| POST /api/rooms/leave | 2 | 30.92 | 37.82 | 37.82 | 37.82 | 0.0 |

## Socket
| Metric | Count | P50 ms | P95 ms | P99 ms | Max ms |
| --- | ---: | ---: | ---: | ---: | ---: |
| socket connect | 2 | 40.01 | 42.98 | 42.98 | 42.98 |
| join_socket -> snapshot | 2 | 11.0 | 14.0 | 14.0 | 14.0 |
| control -> revision | 240 | 10.96 | 26.3 | 33.31 | 89.17 |
...
- Histogram highlights:
  regatta_game_state_payload_bytes [default] count=14 p95=2048.0 p99=2048.0 avg=1385.0714
  regatta_game_state_validation_duration_seconds [default] count=14 p95=0.0005 p99=0.0005 avg=0.0
  regatta_http_request_duration_seconds [endpoint=/api/library/maps,method=GET,status=200] count=1 p95=0.005 p99=0.005 avg=0.0013
  ...
  regatta_http_request_duration_seconds [endpoint=/api/rooms,method=POST,status=200] count=1 p95=0.005 p99=0.005 avg=0.0038
  ...
  regatta_http_request_duration_seconds [endpoint=/api/rooms/<room_code>/start,method=POST,status=200] count=1 p95=0.01 p99=0.01 avg=0.0074
  regatta_http_request_duration_seconds [endpoint=/api/rooms/join,method=POST,status=200] count=1 p95=0.005 p99=0.005 avg=0.0035
  regatta_http_request_duration_seconds [endpoint=/api/rooms/leave,method=POST,status=200] count=2 p95=0.01 p99=0.01 avg=0.0033
  regatta_http_request_duration_seconds [endpoint=/metrics,method=GET,status=200] count=1 p95=0.01 p99=0.01 avg=0.0079
  regatta_public_room_view_duration_seconds [default] count=370 p95=0.0005 p99=0.0005 avg=0.0001
  regatta_public_room_view_payload_bytes [default] count=370 p95=8192.0 p99=8192.0 avg=2287.8081
  ...
  regatta_room_store_duration_seconds [backend=redis,operation=delete_room,result=ok] count=1 p95=0.0005 p99=0.0005 avg=0.0002
  ...
  regatta_room_store_payload_bytes [backend=redis,operation=get_room] count=609 p95=16384.0 p99=16384.0 avg=5287.5156
  regatta_room_store_payload_bytes [backend=redis,operation=save_room] count=364 p95=16384.0 p99=16384.0 avg=5285.1841
  regatta_socket_event_duration_seconds [event=disconnect,result=ok] count=2 p95=0.005 p99=0.005 avg=0.0015
  regatta_socket_event_duration_seconds [event=room:control,result=ok] count=240 p95=0.005 p99=0.005 avg=0.0014
  regatta_socket_event_duration_seconds [event=room:join_socket,result=ok] count=2 p95=0.005 p99=0.005 avg=0.0031

## Findings from load runner
- Socket connect count: 2
- join_socket -> snapshot p95: 14.0 ms
- control -> revision p95: 26.3 ms
- Disconnect rate: 0.0
- Error rate: 0.0
